...
FROM recipes AS r
INNER JOIN accounts ON accounts.id = r.creator_id
WHERE r.id IN (SELECT saves.recipe_id FROM saves WHERE saves.user_id = ?)";
...
<ol id="savesList">
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p class='recipeMsg'>Oops... You don't have any saved recipes</p>";
    }
