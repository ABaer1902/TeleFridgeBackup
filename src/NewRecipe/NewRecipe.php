...
require_once 'BackEnd/RecipeStorage.php';
    ...
    <div id="parent">
        ...
        <form id="newRecipeForm" action="" method="post" enctype="multipart/form-data">
            ...
            <a class="button" id="backButton" href="javascript:history.back()"> <img src="FrontEnd/imgs/back_arrow.png" alt="<---" /> </a>
                <h1 class="message" id="title">Create New Recipe</h1>
            </div>
            <div id="pageContents">
                ...
                <div id="topParent">
                    <div id="left">
                        ...
                        <div class='hprompt' id="nameContainer">
                            ...
                            <input class="inputs" id="recipe-name" type="text" name="recipe-name">
                        </div>
                        
                        <div class='hprompt' id="picContainer">
                            <p class="message" id="picPrompt">Picture:</p>
                            <input type="file" class="inputs" id="recipe-pic" name="recipe-pic" accept="image/png, image/jpeg" required>
                        ...
                        <div class='hprompt' id="timeContainer">
                            ...
                            <input class="inputs" id="hoursInput" type="number" name="hoursInput" min="0" max="23" placeholder="Hours" value="" onfocus="clearInput(this)" autocomplete="on">
                            <p class="message" id="timePrompt">:</p>
                            <input class="inputs" id="minutesInput" type="number" name="minutesInput" min="0" max="59" placeholder="Minutes" value="" onfocus="clearInput(this)" autocomplete="on">
                            </div>
                    ...
                    <div id="right">
                        ...
                        <div class="bigButtonContainer"><button id="cancelButton" class="button" type="button" onclick="clearedForm()"> <img class="image" id="cancelImg" src="FrontEnd/imgs/cancel.png" alt="Cancel"> </button></div>
                    </div>
                </div>
                    ...
                    <div class='fullprompt' id="descriptionContainer">
                        ...
                        <textarea class="fullInputs" class="inputs" id="description" type="text" name="description" placeholder="Click to add a description..."></textarea>
                    </div>

                    <div class='fullprompt' id="instructionContainer">
                        <p class="message" id="instructionPrompt">Instruction:</p>
                        <textarea class="fullInputs" class="inputs" id="instructions" type="text" name="instructions" placeholder="Click to add instructions..."></textarea>
                    </div>
            </div>
        ...
        <script>
           ...
           document.getElementById('instructions').addEventListener('keydown', function(event) {
            ...
            document.getElementById('newRecipeForm').addEventListener('submit', function(event) {
                    ...
                    localStorage.setItem('newrecipe', 'true');
        ...
        <div id="popupOverlayS" class="overlay-containerS"> 
            <div class="popup-box"> 
                ...
                <p id="success"> New recipe added! </p>
                <br>
