function validateForm() {
    ...
    if (calories == ""){
        return "Error: You still need to set the calories.";
    }
...
function togglePopupD(alert) { 
    document.getElementById("deleted").innerHTML = alert;
    const overlay = document.getElementById('popupOverlayD'); 
    overlay.classList.toggle('show'); 
} 

function delete_recipe(recipe_id) {
    event.preventDefault();
    fetch("BackEnd/delete_recipe.php", {
        "method": "POST",
        "headers": {
        ...
        // Either outcome display the message and direct the user to the profile page
        //alert(data["Message"]);
        togglePopupD(data["Message"]);
    })
}
